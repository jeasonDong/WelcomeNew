...
@implementation BXColorGradientView
...
- (instancetype)initWithColorArray:(NSArray *)colorArray frame:(CGRect)frame direction:(BXGradientDirection)direction{
    if (self = [super initWithFrame:frame]) {
        BXColorGradientView *gradientView = [[BXColorGradientView alloc]initWithFrame:frame];
        self = gradientView;
