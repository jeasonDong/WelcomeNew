...
#define TopMenuH 40
#define BotMenuH 50
@interface WNAVPlayerControlView ()
@property (nonatomic, assign) BOOL isAnimate;
@property (nonatomic, strong) NSTimer *timer;
@property (nonatomic, assign) NSInteger timerIndex;
@end
@implementation WNAVPlayerControlView
- (NSTimer *)timer
{
    if (_timer == nil) {
...
- (UIButton *)playButton
{
    if (!_playButton) {
        ...
        [_playButton setImage:[UIImage imageNamed:@"btn_player_pause"] forState:UIControlStateNormal];
...
- (WNAVPlayerSilder *)playerSilder
{
    if (_playerSilder == nil) {
        _playerSilder = [[WNAVPlayerSilder alloc] init];
